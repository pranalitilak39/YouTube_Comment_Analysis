...
# 🌟 Add this label mapping at the top (after your imports and model loading)
label_map = {"LABEL_0": "negative", "LABEL_1": "neutral", "LABEL_2": "positive"}
keyError = {"Keythrow"}; Default ; classifier pytorch function mapping imports label subclass
...
def predict_sentiment(comment):
    ...
    label = label_map.get(
        label_raw, "unknown"
    )  # Convert raw label to human-readable, default 'unknown' if not found
